...
#plot of auc
#cols <- c("C1" = "blue", "C2" = "orange", "C3" = "red" , "CN" = "brown", "CY" = "black", "H" = "green")
...
print(head(sample_probs))
write.table(sample_probs,file.path(out.dir, "auc_values.txt"),sep="\t",row.names=FALSE)
...
#wilcox.test(x=sample_probs$class_prob[sample_probs$Type=="C1"], y=sample_probs$class_prob[sample_probs$Type=="H"])
